...
<table class="table">
  ...
  <tbody>
	...
	<tr>
		<td><c:out value="${page.count}"/></td>
		<td><c:out value="${page.name}"/></td>
		<td><c:out value="${page.link}"/></td>
		<td><c:out value="${page.last_change}"/></td>
		<td><c:out value="${page.check_every}"/></td>
...
<a class="btn btn-primary btn_or red" href="mywebs.html" role="button"> Back </a>
<a class="btn btn-primary btn_or" href="addlink.html" role="button">Add new page</a>
</div>
